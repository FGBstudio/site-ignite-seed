-- La vista portava «cassa» su ogni uscita. Ora il lato passivo ha anche le
-- quote — quanto di una spesa compete a una commessa — e vanno distinte, o il
-- saldo settimanale conta due volte lo stesso hardware.
...
comment on view public.v_cash_events is
  'Ogni movimento, entrate e uscite, nella stessa forma. Porta tre date — evento, documento, cassa — e la natura: solo cassa entra nelle somme, le quote si vedono e basta.';
