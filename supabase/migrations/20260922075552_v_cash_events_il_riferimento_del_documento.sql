-- Lo scadenzario deve dire *perche'* si paga, e la causale senza il numero
-- del documento e' meta' risposta. Il riferimento c'era in uscite_previste ma
-- non usciva; sulle entrate non esiste ancora un numero fattura, quindi vale
...
comment on view public.v_cash_events is
  'Ogni movimento, entrate e uscite, nella stessa forma. Tre date su entrambi i versi — evento, documento, cassa — la natura (solo cassa entra nelle somme), il riferimento del documento e, dove si sa, il progetto a cui compete.';
