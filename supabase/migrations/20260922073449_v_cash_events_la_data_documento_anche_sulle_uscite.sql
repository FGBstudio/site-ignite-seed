-- Le uscite portavano null al posto della data documento, perche' la colonna
-- non esisteva. Ora esiste: la vista ha tre date vere su entrambi i versi,
-- ed e' quello che permette di disegnare l'emissione separata dalla cassa.
...
comment on view public.v_cash_events is
  'Ogni movimento, entrate e uscite, nella stessa forma. Tre date su entrambi i versi — evento, documento, cassa — la natura (solo cassa entra nelle somme) e, dove si sa, il progetto a cui compete.';
