-- La WBS deve poter mettere Schneider Reconfiguration in coda all'elenco
-- progetti, e per farlo il movimento deve sapere a quale lavorazione
-- appartiene. La colonna si aggiunge in fondo: cosi' `create or replace`
-- non litiga con l'ordine delle esistenti.
